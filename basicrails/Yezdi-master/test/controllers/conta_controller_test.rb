...
class ContaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contum" do
    assert_difference('Contum.count') do
      post conta_url, params: { contum: { country: @contum.country, email: @contum.email, male: @contum.male, message: @contum.message, name: @contum.name, phone: @contum.phone } }
    end
  ...
  test "should update contum" do
    patch contum_url(@contum), params: { contum: { country: @contum.country, email: @contum.email, male: @contum.male, message: @contum.message, name: @contum.name, phone: @contum.phone } }
