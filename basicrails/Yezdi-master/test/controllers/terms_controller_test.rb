...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { terms_and_conditions: @term.terms_and_conditions, title: @term.title } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { terms_and_conditions: @term.terms_and_conditions, title: @term.title } }
