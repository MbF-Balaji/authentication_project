...
class DestroysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destroy" do
    assert_difference('Destroy.count') do
      post destroys_url, params: { destroy: { contact: @destroy.contact, country: @destroy.country, email: @destroy.email, male: @destroy.male, message: @destroy.message, name: @destroy.name, phone: @destroy.phone } }
    end
  ...
  test "should update destroy" do
    patch destroy_url(@destroy), params: { destroy: { contact: @destroy.contact, country: @destroy.country, email: @destroy.email, male: @destroy.male, message: @destroy.message, name: @destroy.name, phone: @destroy.phone } }
